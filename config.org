...
:END:
%i |:kill-buffer |t |
| l | Inbox with link | entry | (file org-gtd-inbox-path) | * %? [[%^{Link}][%^{Name}]] |
:PROPERTIES:
:ID: %(org-id-uuid)
:ORG_GTD_CAPTURED_AT: %U
:END:
%i |:kill-buffer |t |
| a | Add to reading list | entry | (file org-gtd-inbox-path) | * Read [[%^{Link}][%^{Name}]] |
:PROPERTIES:
:ID: %(org-id-uuid)
:ORG_GTD_CAPTURED_AT: %U
:DOI: %^{DOI}
...
- Possible group: %^{Group} |:kill-buffer |t |
| m | Meeting | entry | (file org-gtd-inbox-path) | * Meeting with %^{With}: %? |
:PROPERTIES:
:ID: %(org-id-uuid)
:ORG_GTD_CAPTURED_AT: %U
:END: |:kill-buffer |t |
| p | Paper idea | entry | (file org-gtd-inbox-path) | * %? |
:PROPERTIES:
:ID: %(org-id-uuid)
:ORG_GTD_CAPTURED_AT: %U
:END:
- Context: %^{Context} |:kill-buffer |t |
| e | Email to write | entry | (file org-gtd-inbox-path) | * Email %^{To}: %?  :@email: |
:PROPERTIES:
:ID: %(org-id-uuid)
:ORG_GTD_CAPTURED_AT: %U
:END: |:kill-buffer |t |
| d | Appointment/Deadline | entry | (file org-gtd-inbox-path) | * %? %^T |
:PROPERTIES:
:ID: %(org-id-uuid)
:ORG_GTD_CAPTURED_AT: %U
:END: |:kill-buffer |t |
